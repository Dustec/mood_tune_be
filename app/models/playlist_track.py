...
playlist = relationship("app.models.playlist.Playlist", back_populates="tracks")


__table_args__ = (
CheckConstraint("track_order > 0", name="ck_tracks_order_pos"),
CheckConstraint("duration_ms IS NULL OR duration_ms >= 0", name="ck_tracks_duration_nonneg"),
UniqueConstraint("playlist_id", "provider_track_id", name="uq_tracks_playlist_provider_track"),
