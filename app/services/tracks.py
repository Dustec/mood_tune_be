...
raise HTTPException(status_code=422, detail="each_item_requires_provider_track_id_or_track_order")
...
if current is None:
raise HTTPException(status_code=404, detail=f"track_not_found:{it.provider_track_id}")
...
raise HTTPException(status_code=422, detail="duplicate_new_order_values")
